...
public class Player extends Character {
	...
	public Player(Handler handler, BufferedImage b, int x, int y, int width, int height) {
		...
		projectileSpeed = 20;
		projectileDamage = 10;
		projectileType = 1; // Bounce off Walls, Explosive, Armor Piercing,
							// etc... onCollision(...
		rateOfFire = 5;
...
//		}
		 ...
		 * 
		 * 
		 * if (armor > 0){ armor -=3; }else{ health-=5; }
		 * 
		 * }
		 */
		// delete before
	...
	public void shoot() {
		...
		if (shootTick >= rateOfFire) {
			...
			/*
			 * System.out.println(m_RelX); System.out.println(m_RelY);
			 * System.out.println(pXvel); System.out.println(pYvel);
			 */
...
//		}
	...
	// this method adjusts stats if they are over the maximum back to the
	// maximum
